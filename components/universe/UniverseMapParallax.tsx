...
export default function UniverseMapParallax({
  ...
  return (
    ...
    >
      ...
      >
        {/* 遠景丘陵 */}
        <ellipse cx="180" cy="120" rx="200" ry="48" fill="#b8dcc8" opacity="0.55" />
        <ellipse cx="780" cy="100" rx="240" ry="52" fill="#a8d4c0" opacity="0.5" />
        <ellipse cx="520" cy="640" rx="280" ry="44" fill="#c8e0d0" opacity="0.45" />
