...
Subject: 老爺爺 the 吊車, reduced to one continuous rounded silhouette with exactly one defining feature: 吊鉤臂. Front three-quarter-low view; the vehicle's front IS the face — the grille is the mouth; headlights are not the eyes.
