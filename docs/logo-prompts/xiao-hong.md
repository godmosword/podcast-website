...
家族：speed · 車種：賽車 · 特徵：單一尾翼 · Pilot · Tier 1
...
Subject: 小紅 the 賽車, reduced to one continuous rounded silhouette with exactly one defining feature: 單一尾翼. Front three-quarter-low view; the vehicle's front IS the face — grille as mouth, headlights as eyes.
...
Asset paths: public/characters/logo/xiao-hong-512.webp, xiao-hong-128.webp, xiao-hong-32.webp.
```
