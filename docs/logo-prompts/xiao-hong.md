...
Subject: 小紅 the 賽車, reduced to one continuous rounded silhouette with exactly one defining feature: 單一尾翼. Front three-quarter-low view; the vehicle's front IS the face — the grille is the mouth; headlights are not the eyes.
