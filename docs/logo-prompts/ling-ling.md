...
Subject: 玲玲 the 清潔車, reduced to one continuous rounded silhouette with exactly one defining feature: 旋轉刷. Front three-quarter-low view; the vehicle's front IS the face — the grille is the mouth; headlights are not the eyes.
