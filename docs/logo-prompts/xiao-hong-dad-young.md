# 年輕紅爸 · `xiao-hong-dad-young`

家族：speed · 車種：年輕賽車 · 特徵：小尾翼 · Tier 2
...
Subject: 年輕紅爸 the 年輕賽車, reduced to one continuous rounded silhouette with exactly one defining feature: 小尾翼. Front three-quarter-low view; the vehicle's front IS the face — grille as mouth, headlights as eyes.
...
Color: exactly three semantic colors total — two IP base colors (#FF8A72 primary, #C5D8F0 secondary) plus the background. Keep the secondary color as one large continuous region. Silhouette-to-background contrast uses the hue-weighted gate (2.8 / 3.6 / 4.5) with margin >= 0.2; facial marks on the lighter IP region >= 5:1.
...
Asset paths: public/characters/logo/xiao-hong-dad-young-512.webp, xiao-hong-dad-young-128.webp, xiao-hong-dad-young-32.webp.
```
