...
Subject: 噗噗 the 遊園車, reduced to one continuous rounded silhouette with exactly one defining feature: 豬鼻. Front three-quarter-low view; the vehicle's front IS the face — the grille is the mouth; headlights are not the eyes.
