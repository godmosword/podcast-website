...
家族：fantasy · 車種：恐龍車 · 特徵：背鰭 · Tier 1
...
Color: exactly three semantic colors total — two IP base colors (#7DB121 primary, #FBE8C8 secondary) plus the background. Keep the secondary color as one large continuous region. Silhouette-to-background contrast uses the hue-weighted gate (2.8 / 3.6 / 4.5) with margin >= 0.2; facial marks on the lighter IP region >= 5:1.
...
Asset paths: public/characters/logo/duo-duo-512.webp, duo-duo-128.webp, duo-duo-32.webp.
```
