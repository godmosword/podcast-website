...
Subject: 三輪 the 三輪車, reduced to one continuous rounded silhouette with exactly one defining feature: 單前輪. Front three-quarter-low view; the vehicle's front IS the face — the grille is the mouth; headlights are not the eyes.
