...
Subject: 小南 the 捷運, reduced to one continuous rounded silhouette with exactly one defining feature: 圓弧車頭 + 車門. Front three-quarter-low view; the vehicle's front IS the face — the grille is the mouth; headlights are not the eyes.
