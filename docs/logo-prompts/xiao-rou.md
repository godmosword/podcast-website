...
Subject: 小柔 the 露營車, reduced to one continuous rounded silhouette with exactly one defining feature: 車頂帳篷. Front three-quarter-low view; the vehicle's front IS the face — grille as mouth, headlights as eyes.
...
Color: exactly three semantic colors total — two IP base colors (#BF556E primary, #B77888 secondary) plus the background. Keep the secondary color as one large continuous region. Silhouette-to-background contrast uses the hue-weighted gate (2.8 / 3.6 / 4.5) with margin >= 0.2; secondary-to-background >= 3:1; facial marks on the lighter IP region >= 5:1.
...
Asset paths: public/characters/logo/xiao-rou-512.webp, xiao-rou-128.webp, xiao-rou-32.webp.
```
