...
家族：construction · 車種：鑽地車 · 特徵：鑽頭 · Tier 2
...
Subject: 阿酷 the 鑽地車, reduced to one continuous rounded silhouette with exactly one defining feature: 鑽頭. Front three-quarter-low view; the vehicle's front IS the face — grille as mouth, headlights as eyes.
...
Color: exactly three semantic colors total — two IP base colors (#FAA654 primary, #2A2118 secondary) plus the background. Keep the secondary color as one large continuous region. Silhouette-to-background contrast uses the hue-weighted gate (2.8 / 3.6 / 4.5) with margin >= 0.2; facial marks on the lighter IP region >= 5:1.
...
Asset paths: public/characters/logo/a-ku-512.webp, a-ku-128.webp, a-ku-32.webp.
```
