...
Subject: 阿酷 the 鑽地車, reduced to one continuous rounded silhouette with exactly one defining feature: 鑽頭. Front three-quarter-low view; the vehicle's front IS the face — the grille is the mouth; headlights are not the eyes.
