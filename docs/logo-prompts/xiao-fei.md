...
家族：transit · 車種：無人機 · 特徵：螺旋槳環 · Tier 2
...
Color: exactly three semantic colors total — two IP base colors (#F3E6CC primary, #F5D020 secondary) plus the background. Keep the secondary color as one large continuous region. Silhouette-to-background contrast >= 3.6:1 with margin >= 0.2; facial marks on the lighter IP region >= 5:1.
...
Asset paths: public/characters/logo/xiao-fei-512.webp, xiao-fei-128.webp, xiao-fei-32.webp.
```
