...
Subject: 東東 the 挖土機, reduced to one continuous rounded silhouette with exactly one defining feature: 挖斗. Front three-quarter-low view; the vehicle's front IS the face — the grille is the mouth; headlights are not the eyes.
