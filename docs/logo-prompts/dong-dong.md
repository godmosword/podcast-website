...
家族：construction · 車種：挖土機 · 特徵：挖斗 · Pilot · Tier 1
...
Subject: 東東 the 挖土機, reduced to one continuous rounded silhouette with exactly one defining feature: 挖斗. Front three-quarter-low view; the vehicle's front IS the face — grille as mouth, headlights as eyes.
...
Color: exactly three semantic colors total — two IP base colors (#F7A921 primary, #D4EEF4 secondary) plus the background. Keep the secondary color as one large continuous region. Silhouette-to-background contrast uses the hue-weighted gate (2.8 / 3.6 / 4.5) with margin >= 0.2; facial marks on the lighter IP region >= 5:1.
...
Asset paths: public/characters/logo/dong-dong-512.webp, dong-dong-128.webp, dong-dong-32.webp.
```
