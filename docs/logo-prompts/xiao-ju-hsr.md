...
Subject: 小橘 the 高鐵, reduced to one continuous rounded silhouette with exactly one defining feature: 流線頭錐. Front three-quarter-low view; the vehicle's front IS the face — the grille is the mouth; headlights are not the eyes.
