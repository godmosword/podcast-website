...
家族：speed · 車種：賽車 · 特徵：尾翼 + 一道眉線 · Tier 2
...
Subject: 紅爸 the 賽車, reduced to one continuous rounded silhouette with exactly one defining feature: 尾翼 + 一道眉線. Front three-quarter-low view; the vehicle's front IS the face — the grille is the mouth; headlights are not the eyes.
...
Asset paths: public/characters/logo/xiao-hong-dad-512.webp, xiao-hong-dad-128.webp, xiao-hong-dad-32.webp.
```
