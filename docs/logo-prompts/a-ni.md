...
Subject: 阿尼 the 水泥車, reduced to one continuous rounded silhouette with exactly one defining feature: 滾筒. Front three-quarter-low view; the vehicle's front IS the face — the grille is the mouth; headlights are not the eyes.
