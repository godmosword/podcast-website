...
Color: exactly three semantic colors total — two IP base colors (#F7290F primary, #55CAF0 secondary) plus the background. Keep the secondary color as one large continuous region. Silhouette-to-background contrast >= 3:1; facial marks on the lighter IP region >= 4.5:1.
