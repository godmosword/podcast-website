...
Subject: 花餐 the 餐車, reduced to one continuous rounded silhouette with exactly one defining feature: 爆米花桶. Front three-quarter-low view; the vehicle's front IS the face — the grille is the mouth; headlights are not the eyes.
