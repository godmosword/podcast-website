...
Subject: 噴噴 the 消毒車, reduced to one continuous rounded silhouette with exactly one defining feature: 噴嘴. Front three-quarter-low view; the vehicle's front IS the face — the grille is the mouth; headlights are not the eyes.
