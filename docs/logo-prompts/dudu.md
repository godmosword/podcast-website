...
Subject: 嘟嘟 the 小汽車, reduced to one continuous rounded silhouette with exactly one defining feature: 圓拱車頂. Front three-quarter-low view; the vehicle's front IS the face — the grille is the mouth; headlights are not the eyes.
...
Asset paths: public/characters/logo/dudu-512.webp, dudu-128.webp, dudu-32.webp.
```
