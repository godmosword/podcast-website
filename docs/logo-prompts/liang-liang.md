...
Subject: 亮亮 the 警車, reduced to one continuous rounded silhouette with exactly one defining feature: 車頂警示燈條. Front three-quarter-low view; the vehicle's front IS the face — the grille is the mouth; headlights are not the eyes.
