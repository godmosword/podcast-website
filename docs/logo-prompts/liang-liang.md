...
Color: exactly three semantic colors total — two IP base colors (#E8EEF4 primary, #E8C43A secondary) plus the background. Keep the secondary color as one large continuous region. Silhouette-to-background contrast >= 3:1; facial marks on the lighter IP region >= 4.5:1.
