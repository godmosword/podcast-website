...
家族：people · 車種：主持人 · 特徵：麥克風 · Tier 1
...
Subject: 媽咪 the 主持人, reduced to one continuous rounded silhouette with exactly one defining feature: 麥克風.
Microphone is the only feature. Apricot headphones/mic mass is the large secondary region. No beauty mark.
...
Color: exactly three semantic colors total — two IP base colors (#F3D5B0 primary, #F3C090 secondary) plus the background. Keep the secondary color as one large continuous region. Silhouette-to-background contrast uses the hue-weighted gate (2.8 / 3.6 / 4.5) with margin >= 0.2; facial marks on the lighter IP region >= 5:1.
...
Asset paths: public/characters/logo/mami-512.webp, mami-128.webp, mami-32.webp.
```
