...
Subject: 點點 the 消防車, reduced to one continuous rounded silhouette with exactly one defining feature: 水砲. Front three-quarter-low view; the vehicle's front IS the face — grille as mouth, headlights as eyes.
...
Color: exactly three semantic colors total — two IP base colors (#EA2514 primary, #59C9F0 secondary) plus the background. Keep the secondary color as one large continuous region. Silhouette-to-background contrast >= 3:1; facial marks on the lighter IP region >= 4.5:1.
...
Asset paths: public/characters/logo/dian-dian-512.webp, dian-dian-128.webp, dian-dian-32.webp.
```
