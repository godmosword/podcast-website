...
Subject: 點點 the 消防車, reduced to one continuous rounded silhouette with exactly one defining feature: 水砲. Front three-quarter-low view; the vehicle's front IS the face — the grille is the mouth; headlights are not the eyes.
