...
| `joy` | 生活歡樂 | `L 0.30 C 0.06 H 100` | `#352E02` |
...
五個暗底（rescue／speed／construction／fantasy／joy）WCAG 亮度擠在 0.023–0.035，grid 上靠色相分群：藏青 250／青 200／藍紫 300／森綠 150／橄欖 100，兩兩最短距離 ≥ 45°。joy 不用 H 20–30 暖褐：四位粉紅／紅車身會變成同色相呼應，剪影門檻 4.5 過不了。H 110+ 對 fantasy 150 不足 45°。people H 320 與 construction 只差 20°，但亮度 0.147 vs 0.031，grid 分得開。`transit`／`people` 與 `rescue` 本輪不動。
...
| 次色對主色可辨（35 筆全套用） | 對比 ≥ 1.6 **或** 色相差 ≥ 30，擇一 | 識別特徵必須在 32px 從車身分得出來。禁止車身暗一階同色 |
