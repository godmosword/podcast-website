    ...
    <>
      <main className={styles.main}>
        ...
        <section className={styles.section} id="guestbook">
          ...
          <ul className={styles.list}>
            <li>
              頂欄「留言」連到站內留言牆。送出留言即表示理解：審核通過後，<strong>暱稱與正文可能公開</strong>；信箱不會公開。請由家長或照顧者代填。
            </li>
            <li>
        ...
        <section className={styles.section} id="children">
          ...
          <ul className={styles.list}>
            ...
            <li>
              許願與 Email 訂閱須由家長或照顧者勾選同意後才收件。公開留言牆送出即表示理解審核後可能公開暱稱與正文；請由成人代為填寫，並避免在自由文字中留下孩子的個資。
            </li>
            <li>
