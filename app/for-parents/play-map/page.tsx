...
export const metadata: Metadata = {
  title: "親子遊樂地圖：北北基桃適合 3–8 歲的公園與室內樂園",
  description:
    "用地圖快速找適合 3–8 歲小孩的公園、室內樂園與雨天備案；目前收錄台北、新北、基隆、桃園，可依縣市、室內、免費篩選，並一鍵開啟 Google 地圖導航。",
  ...
  openGraph: {
    title: "親子遊樂地圖 · 車車遊樂園",
    description:
      "北北基桃親子遊樂地點地圖：公園、室內樂園與實用 Tips，幫家長快速規劃放電行程。",
    ...
    <main className={styles.main}>
      ...
      <header className={styles.header}>
        ...
        <p className={styles.lede}>
          找適合 3–8 歲的公園與室內樂園，看 Tips、一鍵導航。目前收錄台北、新北、基隆、桃園，其他縣市陸續補上。
        </p>
