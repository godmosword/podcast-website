...
const EXTRA: Record<string, string> = {
  ...
  "diao-che":
    "Only feature: the hook boom. Orange body is the silhouette; warm taupe is the boom. Eyes sit on the lighter orange region. Do not add outriggers.",
  "a-ku":
    "Only feature: a blunt drill bit in the secondary taupe. Do not add tracks or a bucket. Distinct from Dongdong.",
  "a-ni":
  ...
  "xiang-xiang":
    "Diagonal awning: the top edge MUST be a slanted line, unlike Huacan's circle. Awning stripe is the secondary color and the eye surface — never a cream or white window band.",
  "popcorn-truck":
    "Popcorn kettle: the top edge MUST be a circle, unlike Xiangxiang's slant. The kettle is the secondary color and the eye surface — never cream.",
  "pu-pu-pig":
  ...
  "xiao-rou":
    "Roof tent is the only feature. The tent is the secondary color and the eye surface. Do not add a striped side awning or a cream window.",
  "gao-gao":
    "Rim and spokes are the only feature. Gold spokes are the secondary color and the eye surface. No cream hub and no extra gondola colors.",
  dudu: "Arched roof is the only feature — not a race-car spoiler. The roof is the secondary color and the eye surface — never a cream windshield.",
  "duo-duo":
    "Back fins are the only feature. Tips must be blunt, not a sawtooth row. No arms, hands, or teeth.",
  "monster-truck":
    "Giant wheels are the only feature. Warm taupe wheels are the secondary region. No roof light bar.",
  "dirty-germs":
