...
| feat(stories): ep-24 全幕 19 頁插圖 approve（分齡定裝、#15–17 重抽） | 見本 commit |
...
| `illustrate --segment-only` → 生圖 → `--approve` | ✅ | 19 幕全幕繪本；分齡定裝（回憶年幼／年輕爸、當下現在版）；#15–17 爸臉 FACE LOCK 重抽；keepCover 01 → 見本 commit |
