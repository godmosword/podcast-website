...
> **資料基準（2026-09-20）：** `storiesByNewest()` **30 集**、最新 **`ep-30`**（2026-09-16，MVP 單封面）。
> **出圖落後：** 多頁插圖至 **`ep-29`（15 頁，`77429838`）**；`ep-25`／`ep-26`／`ep-27`／`ep-28`／`ep-30` 仍為 `pageCount=1` MVP。最新全幕含 **`ep-21`（18 頁）**／**`ep-22`（24 頁）**／**`ep-23`（26 頁）**／**`ep-24`（19 頁）**／**`ep-29`（15 頁）**。
> 完整逐字稿覆蓋至 `ep-30`（ep-1–10 已補 `--mark`；ep-11 起原本已標記；`ep-30` 已校對＋手切 18 幕，待出圖 `8ad9df05`）。`data/games.ts` 見下表。
>
