...
| MAP-MOBILE-FIT | P1 | 進行中 | 手機首屏：隱藏標題 pill／探險小抄（sr-only）＋ `FIT_MARGIN` 0.96 | `MapGuide.module.css`、`UniverseMap.module.css`、`map-camera-utils.ts` | 單元＋CSS 契約＋`universe-map` e2e |
